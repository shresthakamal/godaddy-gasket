...
import { PartType, reverseTraverseAsync } from '../src/transforms';
...
describe('reverseTraverseAsync', function () {
  ...
  describe('delegate receives part type', function () {
    ...
    it(PartType.name, async function () {
      const value = [['h1', null]];
      await reverseTraverseAsync(value, mockDelegate);
    ...
    it(PartType.name + ' from props', async function () {
    ...
    it(PartType.props, async function () {
    ...
    it(PartType.props + ' from children', async function () {
    ...
    it(PartType.childString, async function () {
    ...
    it(PartType.childString + ' from props', async function () {
    ...
    it(PartType.childString + ' from children in props', async function () {
    ...
    it(PartType.childString + ' from children in children', async function () {
    ...
    it(PartType.stringValue, async function () {
    ...
    it(PartType.stringValue + ' from children', async function () {
      const value = [['h1', null, ['a node string', ['span', { key: 'a value' }]]]];
      await reverseTraverseAsync(value, mockDelegate);
  ...
  describe(PartType.node, function () {
    ...
    it('is visited in children', async function () {
    ...
    it('is visited in props', async function () {
      const value = ['h1', {
        key: 'a value',
    ...
    it('can be removed from children', async function () {
      const value = ['h1', { key: 'a value' }, [
        ['h2', { key: 'a child value' }],
        ['h3', { key: 'another child value' }]
      ]];
      ...
      const results = await reverseTraverseAsync(value, mockDelegate);
    ...
    it('does no harm to non-children arrays', async function () {
    ...
    it('can be removed from props', async function () {
      const value = ['h1', {
        key: 'a value',
        child: ['h2', { key: 'a child value' }]
      }];
    ...
    it('does no harm to empty string children', async function () {
      const value = ['h1', { key: 'a value' }, [
        ['h2', { key: 'a child value' }],
        '',
        ' ',
