...
vi.mock('../src/navigation', () => {
  return {
    Navigation: vi.fn(() => <div data-testid='header-nav'></div>)
  };
});

const { Navigation: NavigationSpy } = await import('../src/navigation');
const { default: withHeaderNav } = await import('../src/with-header-nav');
