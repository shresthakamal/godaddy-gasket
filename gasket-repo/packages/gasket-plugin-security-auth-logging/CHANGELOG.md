...
- Also log client ip, move other logging fields around to match ECS logging format and requests from security team
...
[#1664]: https://github.com/gdcorp-uxp/gasket/pull/1664
