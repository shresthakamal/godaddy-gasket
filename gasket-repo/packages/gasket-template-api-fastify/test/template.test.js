...
describe('@godaddy/gasket-template-api-fastify', () => {
  ...
  describe('TypeScript Configuration', () => {
    ...
    it('should have proper TypeScript config for Fastify API', () => {
  ...
  describe('Package.json Validation', () => {
    ...
    it('should have Fastify API dependencies', () => {
      const requiredDeps = [
        '@gasket/core',
        '@gasket/data',
    ...
    it('should have Fastify and not Express plugin dependencies', () => {
      ...
      expect(packageJson.dependencies).not.toHaveProperty('@gasket/plugin-express');
    });
  });
  ...
  describe('Gasket Configuration', () => {
    it('should have valid gasket.ts', () => {
      ...
      expect(content).toMatch(/pluginFastify/);
      expect(content).toMatch(/export default/);
      expect(content).not.toMatch(/pluginExpress/);
    });
  ...
  describe('Plugin Structure', () => {
    it('should have routes plugin', () => {
      ...
      expect(content).toMatch(/hooks:\s*{[\s\S]*fastify/);
      expect(content).toMatch(/@swagger/);
      expect(content).not.toMatch(/express/);
    });
  ...
  describe('Fastify-Specific Features', () => {
    it('should use Fastify instead of Express plugin', () => {
      const packagePath = path.join(templatePath, 'package.json');
    ...
    it('should have Fastify in plugin configuration', () => {
      const gasketPath = path.join(templatePath, 'gasket.ts');
      const content = fs.readFileSync(gasketPath, 'utf8');
