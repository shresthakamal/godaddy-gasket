...
describe('@godaddy/gasket-template-webapp-pages', () => {
  ...
  describe('Pages Router Structure', () => {
    ...
    it('should not have App Router files', () => {
      const appRouterFiles = ['app/layout.tsx', 'app/page.tsx'];
    ...
    it('should have API route for auth validation', () => {
      const apiPath = path.join(templatePath, 'pages/api/auth/validate.ts');
      expect(fs.existsSync(apiPath)).toBe(true);

      const content = fs.readFileSync(apiPath, 'utf8');
      expect(content).toMatch(/checkAuth/);
    });
  ...
  describe('Proxy Server Configuration', () => {
    it('should have server.ts with proxy server setup', () => {
  ...
  describe('Package.json Validation', () => {
    ...
    it('should have proxy server-specific dependencies', () => {
      expect(packageJson.dependencies).toHaveProperty('@gasket/plugin-https-proxy');
    ...
    it('should have correct scripts', () => {
      ...
      // Check TypeScript/proxy server-specific scripts
      expect(packageJson.scripts).toHaveProperty('start:https');
      expect(packageJson.scripts).toHaveProperty('local:https');
      expect(packageJson.scripts['start:https']).toMatch(/dist\/server\.js/);
      expect(packageJson.scripts['local:https']).toMatch(/tsx watch/);
  ...
  describe('Configuration Files', () => {
    ...
    it('should have middleware.ts for Pages Router', () => {
